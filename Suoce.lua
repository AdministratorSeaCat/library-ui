if (game:GetService("CoreGui")):FindFirstChild("RyvexHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).ShinichiHub:Destroy();
...
ImageButton.Image = "rbxassetid://97744423950853";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("ShinichiHub")).Enabled = not (game.CoreGui:FindFirstChild("ShinichiHub")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://97744423950853";
	Title.Parent = Frame;
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("RyvexHub") then
			makefolder("RyvexHub");
		end;
		if not isfolder("RyvexHub/Library/") then
			makefolder("RyvexHub/Library/");
		end;
		if not isfile(("RyvexHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("RyvexHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("RyvexHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("RyvexHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("RyvexHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	ShinichiHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = ShinichiHub;
